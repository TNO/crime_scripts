...
- 2026-09-17 Copilot: Branch-level review fixed the GitHub Pages starter URL to resolve from `document.baseURI` and made starter imports apply workspace-wide ID collision remapping with final uniqueness validation. Added regressions for the production base path and cross-scope taxonomy/owned-ID collisions.
