...
export const messages = {
  ...
  BUILD_SCRIPT_HELP: 'Choose a scene, structure its steps, then enrich only the selected item.',
  ...
  NO_STEPS_HELP: 'Add a first step, or paste a Markdown outline.',
  ADD_STEP: 'Add step',
  NEW_STEP: 'New step',
  ADD_SUBSTEP: 'Add substep',
  NEW_SUBSTEP: 'New substep',
  MOVE_UP: 'Move up',
  MOVE_DOWN: 'Move down',
  DELETE_STEP: 'Delete step',
  DELETE_SUBSTEP: 'Delete substep',
  DELETE_STEP_CONFIRM: 'Delete “{name}” and its {count} substeps? This cannot be undone.',
  DELETE_SCENE: 'Delete scene',
  DELETE_SCENE_CONFIRM: 'Delete the scene “{name}”, including all routes and steps? This cannot be undone.',
  STEP_DETAILS: 'Step details',
  SUBSTEP_DETAILS: 'Substep details',
  BACK_TO_SCENE: 'Scene details',
  PARENT_STEP: 'Part of',
  TOP_LEVEL_STEP: 'Top-level step',
  EDIT_MARKDOWN_OUTLINE: 'Edit outline',
  MARKDOWN_OUTLINE: 'Markdown outline',
  MARKDOWN_OUTLINE_HELP:
    'Use one bullet per step and indent substeps by two spaces. Keep the hidden ID comments when editing with AI so attached details remain connected.',
