...
export const messages = {
  ...
  EXPORT_BARRIER_SVG: 'Export barrier model as SVG',
  EXPORT_BARRIER_PNG: 'Export barrier model as PNG',
  EXPORT_FAILED: 'The export failed.',
  BARRIER_MODEL: 'Barrier model',
  BARRIER_MODEL_ALT: 'Matrix of barriers by crime-script scene, with applicable partners in each populated cell.',
  BARRIER_MODEL_FALLBACK: 'The detailed barrier tables in the scene chapters provide the accessible textual version of this visual.',
  NO_BARRIERS: 'No barriers are available for this script.',
  BARRIER_RENDER_FAILED: 'The barrier model could not be rendered.',
  ...
  ENGLISH: 'English',
  ROLE: 'Role',
  ADD_ACT: 'New modus operandi',
  DELETE_ACT: 'Delete modus operandi',
  DELETE_ACT_CONFIRM: 'Are you sure that you want to permanently delete modus operandi "{name}"?',
  SELECT_ACT: 'Choose modus operandi',
  SELECT_ACT_N: 'Create a new modus operandi or select an alternative',
  ...
  BUILD_SCRIPT: 'Build the script',
  BUILD_SCRIPT_HELP: 'Choose a scene, structure its activities, then enrich only the selected item.',
  SCRIPT_OUTLINE: 'Script outline',
  ADD_SCENE: 'Add scene',
  NEW_SCENE: 'New scene',
  UNTITLED_SCENE: 'Untitled scene',
  SCENE_CONTEXT: 'Scene {index}',
  NO_SCENES: 'No scenes yet',
  NO_SCENES_HELP: 'Add a scene to start structuring this crime script.',
  ACTIVITY_COUNT: '{count} activities',
  MODUS_OPERANDI_COUNT: '{count} M.O.',
  NO_STEPS_HELP: 'Add a first activity, or paste a Markdown outline.',
  ADD_STEP: 'Add activity',
  NEW_STEP: 'New activity',
  ADD_SUBSTEP: 'Add subactivity',
  NEW_SUBSTEP: 'New subactivity',
  MOVE_UP: 'Move up',
  MOVE_DOWN: 'Move down',
  DELETE_STEP: 'Delete activity',
  DELETE_SUBSTEP: 'Delete subactivity',
  DELETE_STEP_CONFIRM: 'Delete “{name}” and its {count} subactivities? This cannot be undone.',
  DELETE_SCENE: 'Delete scene',
  DELETE_SCENE_CONFIRM: 'Delete the scene “{name}”, including all modi operandi and activities? This cannot be undone.',
  STEP_DETAILS: 'Activity details',
  SUBSTEP_DETAILS: 'Subactivity details',
  BACK_TO_SCENE: 'Scene details',
  PARENT_STEP: 'Part of',
  TOP_LEVEL_STEP: 'Top-level activity',
  EDIT_MARKDOWN_OUTLINE: 'Edit outline',
  MARKDOWN_OUTLINE: 'Markdown outline',
  MARKDOWN_OUTLINE_HELP:
    'Use one bullet per activity and indent subactivities by two spaces. Keep the hidden ID comments when editing with AI so attached details remain connected.',
  SOURCES_AND_REFERENCES: '{count} sources and references',
  ...
  OUTLINE_INVALID: 'The outline needs attention.',
  OUTLINE_ADDED: '{count} added',
  OUTLINE_UPDATED: '{count} renamed',
  OUTLINE_MOVED: '{count} regrouped',
  OUTLINE_PRESERVED: '{count} omitted but preserved',
  OUTLINE_NO_DELETE: 'Items omitted from Markdown are preserved. Delete them explicitly from the outline.',
