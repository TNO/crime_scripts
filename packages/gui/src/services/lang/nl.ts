...
export const messagesNL: typeof messages = {
  ...
  EXPORT_BARRIER_SVG: 'Barrièremodel exporteren als SVG',
  EXPORT_BARRIER_PNG: 'Barrièremodel exporteren als PNG',
  EXPORT_FAILED: 'De export is mislukt.',
  BARRIER_MODEL: 'Barrièremodel',
  BARRIER_MODEL_ALT: 'Matrix met barrières per crimescriptscène en de toepasselijke partners in iedere gevulde cel.',
  BARRIER_MODEL_FALLBACK: 'De gedetailleerde barrièretabellen in de scènehoofdstukken vormen de toegankelijke tekstversie van deze visualisatie.',
  NO_BARRIERS: 'Voor dit script zijn geen barrières beschikbaar.',
  BARRIER_RENDER_FAILED: 'Het barrièremodel kon niet worden gerenderd.',
  ...
  RESTRICTED_MODE: 'Afgeschermde modus',
  RESTRICTED_MODE_NOTICE: 'Afgeschermde scripts kunnen gevoelige operationele details bevatten.',
  CLASSIFICATION: 'Classificatie',
  PUBLIC: 'Publiek',
  RESTRICTED: 'Afgeschermd',
  CREATE_RESTRICTED_VERSION: 'Afgeschermde versie maken',
  RESTRICTED_VERSION_EXISTS: 'Er bestaat al een afgeschermde versie.',
  ...
  ENGLISH: 'Engels',
  ROLE: 'Rol',
  ADD_ACT: 'Nieuwe modus operandi',
  DELETE_ACT: 'Verwijder modus operandi',
  DELETE_ACT_CONFIRM: 'Weet je zeker dat je de modus operandi "{name}" wilt verwijderen?',
  SELECT_ACT: 'Kies modus operandi',
  SELECT_ACT_N: 'Maak een nieuwe modus operandi aan of selecteer een alternatief',
  ...
  STEPS: 'Activiteiten',
  SCRIPT_DETAILS: 'Scriptgegevens',
  BUILD_SCRIPT: 'Bouw het script op',
  BUILD_SCRIPT_HELP: 'Kies een scène, structureer de activiteiten en verrijk daarna alleen het geselecteerde onderdeel.',
  SCRIPT_OUTLINE: 'Scriptstructuur',
  ADD_SCENE: 'Scène toevoegen',
  NEW_SCENE: 'Nieuwe scène',
  UNTITLED_SCENE: 'Scène zonder titel',
  SCENE_CONTEXT: 'Scène {index}',
  NO_SCENES: 'Nog geen scènes',
  NO_SCENES_HELP: 'Voeg een scène toe om dit crimescript te structureren.',
  ACTIVITY_COUNT: '{count} activiteiten',
  MODUS_OPERANDI_COUNT: '{count} M.O.',
  NO_STEPS_HELP: 'Voeg een eerste activiteit toe of plak een Markdown-structuur.',
  ADD_STEP: 'Activiteit toevoegen',
  NEW_STEP: 'Nieuwe activiteit',
  ADD_SUBSTEP: 'Subactiviteit toevoegen',
  NEW_SUBSTEP: 'Nieuwe subactiviteit',
  MOVE_UP: 'Omhoog verplaatsen',
  MOVE_DOWN: 'Omlaag verplaatsen',
  DELETE_STEP: 'Activiteit verwijderen',
  DELETE_SUBSTEP: 'Subactiviteit verwijderen',
  DELETE_STEP_CONFIRM: '“{name}” en de {count} subactiviteiten verwijderen? Dit kan niet ongedaan worden gemaakt.',
  DELETE_SCENE: 'Scène verwijderen',
  DELETE_SCENE_CONFIRM: 'De scène “{name}”, inclusief alle modi operandi en activiteiten, verwijderen? Dit kan niet ongedaan worden gemaakt.',
  STEP_DETAILS: 'Activiteitgegevens',
  SUBSTEP_DETAILS: 'Subactiviteitgegevens',
  BACK_TO_SCENE: 'Scènegegevens',
  PARENT_STEP: 'Onderdeel van',
  TOP_LEVEL_STEP: 'Hoofdactiviteit',
  EDIT_MARKDOWN_OUTLINE: 'Structuur bewerken',
  MARKDOWN_OUTLINE: 'Markdown-structuur',
  MARKDOWN_OUTLINE_HELP:
    'Gebruik één opsommingsteken per activiteit en spring subactiviteiten twee spaties in. Laat de verborgen ID-opmerkingen staan bij bewerking met AI, zodat gekoppelde gegevens behouden blijven.',
  SCRIPT_CONTENT_SUMMARY: 'Scriptgegevens',
  SOURCES_AND_REFERENCES: 'Bronnen en referenties',
  ROLE_COUNT: '{count} rollen',
  ATTRIBUTE_COUNT: '{count} attributen',
  TRANSPORT_COUNT: '{count} transportmiddelen',
  LOCATION_COUNT: '{count} locaties',
  REFERENCE_COUNT: '{count} referenties',
  ...
  PREVIEW_CHANGES: 'Wijzigingen bekijken',
  OUTLINE_INVALID: 'De structuur moet worden aangepast.',
  OUTLINE_ADDED: '{count} toegevoegd',
  OUTLINE_UPDATED: '{count} hernoemd',
  OUTLINE_MOVED: '{count} anders gegroepeerd',
  OUTLINE_PRESERVED: '{count} weggelaten maar behouden',
  OUTLINE_NO_DELETE: 'Onderdelen die niet in Markdown staan blijven behouden. Verwijder ze expliciet uit de structuur.',
  APPLY_OUTLINE: 'Structuur toepassen',
  HEADER: 'Titel',
