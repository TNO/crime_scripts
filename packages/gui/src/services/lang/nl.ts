...
export const messagesNL: typeof messages = {
  ...
  ROLE: 'Rol',
  ADD_ACT: 'Nieuwe acte',
  DELETE_ACT: 'Verwijder acte',
  DELETE_ACT_CONFIRM: 'Weet je zeker dat je de acte "{name}" wilt verwijderen?',
  SELECT_ACT: 'Bewerk acte',
  SELECT_ACT_N: 'Selecteer bestaande acte(s)',
