...
export const messagesNL: typeof messages = {
  ...
  BUILD_SCRIPT_HELP: 'Kies een scène, structureer de stappen en verrijk daarna alleen het geselecteerde onderdeel.',
  ...
  NO_STEPS_HELP: 'Voeg een eerste stap toe of plak een Markdown-structuur.',
  ADD_STEP: 'Stap toevoegen',
  NEW_STEP: 'Nieuwe stap',
  ADD_SUBSTEP: 'Substap toevoegen',
  NEW_SUBSTEP: 'Nieuwe substap',
  MOVE_UP: 'Omhoog verplaatsen',
  MOVE_DOWN: 'Omlaag verplaatsen',
  DELETE_STEP: 'Stap verwijderen',
  DELETE_SUBSTEP: 'Substap verwijderen',
  DELETE_STEP_CONFIRM: '“{name}” en de {count} substappen verwijderen? Dit kan niet ongedaan worden gemaakt.',
  DELETE_SCENE: 'Scène verwijderen',
  DELETE_SCENE_CONFIRM: 'De scène “{name}”, inclusief alle routes en stappen, verwijderen? Dit kan niet ongedaan worden gemaakt.',
  STEP_DETAILS: 'Stapgegevens',
  SUBSTEP_DETAILS: 'Substapgegevens',
  BACK_TO_SCENE: 'Scènegegevens',
  PARENT_STEP: 'Onderdeel van',
  TOP_LEVEL_STEP: 'Hoofdstap',
  EDIT_MARKDOWN_OUTLINE: 'Structuur bewerken',
  MARKDOWN_OUTLINE: 'Markdown-structuur',
  MARKDOWN_OUTLINE_HELP:
    'Gebruik één opsommingsteken per stap en spring substappen twee spaties in. Laat de verborgen ID-opmerkingen staan bij bewerking met AI, zodat gekoppelde gegevens behouden blijven.',
